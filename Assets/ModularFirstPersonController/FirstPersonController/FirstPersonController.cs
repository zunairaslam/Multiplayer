...
public class FirstPersonController : NetworkBehaviour
{
    ...
    void Start()
    {
        ...
        sprintBarCG = GetComponentInChildren<CanvasGroup>(includeInactive: true);
    ...
    private void Update()
    {
        // Only allow input if this player has input authority
    ...
    void FixedUpdate()
    {
        ...
        // Only allow movement if this player has input authority
        NetworkObject networkObject = GetComponent<NetworkObject>();
        if (networkObject != null && !networkObject.HasInputAuthority)
        {
            return;
